		...
		<div className='max-w-2xl space-y-6'>
			...
			<div className='space-y-2'>
				{sections.map(({ href, icon: Icon, label, description }) => (
					<Link key={href} href={href} className='flex items-center gap-4 p-4 bg-white border rounded-lg hover:bg-gray-50 transition-colors group'>
			...
			<div className='md:hidden pt-2'>
				...
				<div className='text-xs text-gray-500 mb-3'>
					Developed by{' '}
					<a href='https://www.zayarlyn.com' target='_blank' rel='noopener noreferrer' className='underline text-gray-700'>
						Zayar Lin
					</a>
				</div>
				<SignOutButton />
