		...
		<div className='min-h-screen flex flex-col items-center justify-center bg-[#f5f7fa] relative overflow-hidden p-4'>
			...
			<div className='relative z-10 w-full max-w-[420px] mx-4 bg-white border border-[#e7e8eb] rounded-[20px] shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05)] p-6 sm:p-10'>
				<div className='mb-5'>
					...
					<p className='text-[14px] text-[#6c7688] mt-1 leading-[21px]'>Please enter your details to access the dashboard</p>
				</div>

				<form onSubmit={handleSubmit} className='space-y-4'>
					<div className='space-y-1'>
						<Label htmlFor='username' className='text-[13px] font-medium text-[#0a1b39]'>
							Username
						</Label>
						<Input
							id='username'
					...
					<div className='space-y-1'>
						<Label htmlFor='password' className='text-[13px] font-medium text-[#0a1b39]'>
							Password
						</Label>
						<Input
							id='password'
